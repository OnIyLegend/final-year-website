...
<div class="container-fluid padding">
    <div class="row text-center padding">
        <div class=" col-lg-6">
            ...
            <p> This website is dedicated to provide diehard fans and casual fans alike, that enjoy F1 and F1 stats to search up on any data that they desire that goes back to the inception of F1 in 1950 up until the latest season of 2020. Using this data the page will be able to show analysed data visualized.

						Then compare them and produce a general analytic panel that then will be present to the user the information they need. ...
            </p>
